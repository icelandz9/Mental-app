...
**อธิบาย:** ล็อกอินด้วยอีเมล/รหัสผ่าน → สำเร็จไปหน้า Home → ผิดพลาดแจ้งเตือน
...
**อธิบาย:** `saveProfile` บันทึกข้อมูลส่วนตัวลง Firestore, `loadProfile` อ่านกลับมาเติมในฟอร์มอัตโนมัติ
...
**อธิบาย:** ควบคุมการทำแบบทดสอบทีละข้อ — เก็บ/โหลดความคืบหน้าไว้ในเครื่อง (กันเผลอปิดแอป), ตรวจว่าตอบครบก่อนไปต่อ, และข้อสุดท้ายพาไปหน้าผลลัพธ์
...
**อธิบาย:** วนคิดคะแนนของแบบทดสอบทั้ง 7 ชุด โดยรวมคะแนนจากคำตอบที่ผู้ใช้เลือก แล้วส่งต่อไปแปลผล
...
**อธิบาย:** แปลคะแนนดิบเป็นระดับความรุนแรงตามเกณฑ์คลินิกของแต่ละแบบทดสอบ — PHQ-9/GAD-7/PSS ใช้ช่วงคะแนน (band) ส่วน ASRS/OCI-R/PCL-5/MDQ ใช้จุดตัด (cutoff)
...
**อธิบาย:** บันทึกผลลง `users/{uid}/results` (เก็บเวลา จำนวนด้านที่ควรใส่ใจ สัญญาณเสี่ยง และผลรายแบบทดสอบ) — `_saved` กันบันทึกซ้ำ
...
**อธิบาย:** คืน Stream ของผลประเมินผู้ใช้ (ใหม่สุดก่อน) — `.snapshots()` ทำให้หน้าจออัปเดตเองเมื่อมีผลใหม่
...
**อธิบาย:** ผู้ใช้ทั่วไปเห็นเฉพาะข้อมูลของตนเอง แอดมินเห็นได้ทุกคน และผลประเมินที่บันทึกแล้วห้ามแก้/ลบ
...
**อธิบาย:** เว็บแยกสำหรับผู้ดูแล ใช้ Firebase JS SDK อ่านโปรไฟล์และผลประเมินของผู้ใช้ทุกคน (ผ่าน `collectionGroup`) มารวมแสดงเป็นการ์ดรายคน
